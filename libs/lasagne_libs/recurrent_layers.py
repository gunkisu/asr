...
class FixedLayerNormProjectLSTMLayer(MergeLayer):
    def __init__(self,
                 incoming,
                 mask_input,
                 num_units,
        ...
        super(FixedLayerNormProjectLSTMLayer, self).__init__(incomings, **kwargs)
...
class FixedCondLayerNormProjectLSTMLayer(MergeLayer):
    def __init__(self,
                 incoming,
                 mask_input,
                 num_units,
        ...
        super(FixedCondLayerNormProjectLSTMLayer, self).__init__(incomings, **kwargs)
...
class FixedInputCondLayerNormProjectLSTMLayer(MergeLayer):
    def __init__(self,
                 incoming,
                 cond_input,
                 mask_input,
        ...
        super(FixedInputCondLayerNormProjectLSTMLayer, self).__init__(incomings, **kwargs)
    ...
    def get_output_for(self, inputs, deterministic=False, **kwargs):
        ...
        alpha_in = T.dot(ln_data, self.W_alpha_in) + self.b_alpha_in
        alpha_hid = T.dot(ln_data, self.W_alpha_hid) + self.b_alpha_hid
        beta = T.dot(ln_data, self.W_beta) + self.b_beta
...
class FixedMaxCondLayerNormProjectLSTMLayer(MergeLayer):
    def __init__(self,
                 incoming,
                 mask_input,
                 num_units,
        ...
        super(FixedMaxCondLayerNormProjectLSTMLayer, self).__init__(incomings, **kwargs)
...
class FixedMaxInputCondLayerNormProjectLSTMLayer(MergeLayer):
    def __init__(self,
                 incoming,
                 cond_input,
                 mask_input,
        ...
        super(FixedMaxInputCondLayerNormProjectLSTMLayer, self).__init__(incomings, **kwargs)
