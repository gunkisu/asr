...
class ScalingHyperLSTMLayer(MergeLayer):
    def __init__(self,
        ...
        if scale_nonlinearity is None:
            self.scale_nonlinearity = nonlinearities.identity
        else:
        ...
        self.W_inner_cell_to_ingate = self.add_param(init.Uniform(0.1),
                                                         shape=(num_inner_units, ),
        ...
        self.W_inner_cell_to_forgetgate = self.add_param(init.Uniform(0.1),
                                                         shape=(num_inner_units, ),
        ...
        self.W_inner_cell_to_outgate = self.add_param(init.Uniform(0.1),
                                                      shape=(num_inner_units, ),
        ...
        # inner-to-factor #
        ###################
        def add_inner2fact_params(gate_name):
