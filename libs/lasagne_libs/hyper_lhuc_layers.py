...
class SpeakerLHUCLSTMLayer(MergeLayer):
    ...
    def init_lhuc_weights_helper(self, embedding_dim):
        ...
        self.W_pred_list.append(self.add_param(weight_init, (input_dim, self.num_proj_units),
                            name="W_e_h_{}".format(self.num_pred_layers)))
        self.b_pred_list.append(self.add_param(bias_init, (self.num_proj_units,),
    ...
    def __init__(self, incoming, num_units, num_pred_units, num_pred_layers=1,
                 ingate=Gate(),
                 forgetgate=Gate(),
                 cell=Gate(W_cell=None, nonlinearity=nonlinearities.tanh),
                 outgate=Gate(),
...
class SummarizingLHUCLSTMLayer(SpeakerLHUCLSTMLayer):
    ...
    def __init__(self, incoming, num_units, num_pred_units, num_pred_layers=1, 
        ...
        super(SummarizingLHUCLSTMLayer, self).__init__(incoming, num_units, num_pred_units, num_pred_layers,
                 ingate, forgetgate, cell, outgate, nonlinearity, cell_init, hid_init, backwards,
...
class SeqSumLHUCLSTMLayer(SpeakerLHUCLSTMLayer):
    ...
    def __init__(self, incoming, speaker_input, num_units, num_pred_units, num_pred_layers=1, 
                 ingate=Gate(),
                 forgetgate=Gate(),
                 cell=Gate(W_cell=None, nonlinearity=nonlinearities.tanh),
                 outgate=Gate(),
        ...
        super(SeqSumLHUCLSTMLayer, self).__init__(incoming, num_units, num_pred_units, num_pred_layers, 
                 ingate, forgetgate, cell, outgate, nonlinearity, cell_init, hid_init, backwards,
...
class IVectorLHUCLSTMLayer(SpeakerLHUCLSTMLayer):
    def __init__(self, incoming, ivector_input, num_units, num_pred_units, num_pred_layers=1, 
                 ingate=Gate(),
                 forgetgate=Gate(),
                 cell=Gate(W_cell=None, nonlinearity=nonlinearities.tanh),
                 outgate=Gate(),
        ...
        super(IVectorLHUCLSTMLayer, self).__init__(incoming, num_units, num_pred_units, num_pred_layers,
                 ingate, forgetgate, cell, outgate, nonlinearity, cell_init, hid_init, backwards,
                 grad_clipping, mask_input, 
