...
from libs.lasagne_libs.gating_layers import SkipLSTMLayer, DiffSkipLSTMLayer
...
def deep_bidir_diff_skip_lstm_model(input_var,
                                    mask_var,
                                    num_inputs,
                                    num_units_list,
                                    num_outputs,
    ...
    for num_units in num_units_list:
        ...
        # forward lstm
        lstm_fwd_layer = DiffSkipLSTMLayer(input_data_layer=prev_input_layer,
                                           input_mask_layer=mask_layer,
                                           num_units=num_units,
                                           skip_scale=skip_scale,
                                           gradient_steps=gradient_steps,
        ...
        # backward lstm
        lstm_bwd_layer = DiffSkipLSTMLayer(input_data_layer=prev_input_layer,
                                           input_mask_layer=mask_layer,
                                           num_units=num_units,
                                           skip_scale=skip_scale,
                                           gradient_steps=gradient_steps,
