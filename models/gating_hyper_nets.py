...
# fix versions #
################
def deep_prj_lstm_model_v1(input_var,
                           mask_var,
                           num_inputs,
                           num_outputs,
                           num_layers,
...
def deep_prj_lstm_ln_model_v1(input_var,
                              mask_var,
                              num_inputs,
                              num_outputs,
                              num_layers,
...
def deep_prj_lstm_ln_model_v2(input_var,
                              mask_var,
                              num_inputs,
                              num_outputs,
                              num_layers,
...
def deep_prj_lstm_dln_model_v1(input_var,
                               mask_var,
                               num_inputs,
                               num_outputs,
                               num_units,
...
def deep_prj_lstm_dln_model_v2(input_var,
                               mask_var,
                               num_inputs,
                               num_outputs,
                               num_units,
