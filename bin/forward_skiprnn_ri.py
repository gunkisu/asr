...
SampleGraph = namedtuple('SampleGraph', 'step_label_probs step_action_samples step_action_probs step_action_greedy step_last_state step_x_data init_state')
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        sample_graph = SampleGraph(_step_label_probs, step_action_samples, step_action_probs, step_action_greedy, step_last_state, step_x_data, init_state)
