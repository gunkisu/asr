...
#model=~/song/asr/skiprnn_ri_a6_y_e32/best_model.ckpt-11690.meta
#forward=~/song/asr/bin/forward_skiprnn_ri.py

# skiprnn with subsampling
#dir=exp/hyperud/decode_bd_tgpr_dev93_skiprnn_subsample_s1
#model=~/song/asr/skiprnn_subsample_s1/best_model.ckpt-7014.meta
#forward=~/song/asr/bin/forward_skiprnn_subsample.py

# skiprnn trained with supervised training
dir=exp/hyperud/decode_bd_tgpr_dev93_skiprnn_sv_a4
model=~/song/asr/skip_lstm_supervised_a7/best_model.ckpt-32732.meta
~/song/asr/skiprnn_sv_a4/best_model.ckpt-9352.meta
