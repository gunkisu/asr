...
from models.gating_hyper_nets import uni_lstm_model
...
def add_params(parser):
    ...
    parser.add_argument('--updater', help='sgd or momentum', default='adam')
...
def build_trainer(input_data,
    ...
    train_total_loss = train_loss + apply_penalty(network_reg_params, l2)*1e-5
...
if __name__ == '__main__':
    ...
    network_output = uni_lstm_model(input_var=input_data,
                                    mask_var=input_mask,
