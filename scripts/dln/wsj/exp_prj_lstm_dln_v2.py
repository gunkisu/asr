...
from models.gating_hyper_nets import deep_prj_lstm_dln_model_v2
...
if __name__ == '__main__':
    ...
    network_output, cond_layer_list = deep_prj_lstm_dln_model_v2(input_var=input_data,
                                                                 mask_var=input_mask,
