...
from models.gating_hyper_nets import deep_reg_lstm_ln_model_v1, deep_reg_lstm_ln_model_v2
...
if __name__ == '__main__':
    ...
    model_fn = None
    if args.version==1:
        model_fn = deep_reg_lstm_ln_model_v1
    else:
        model_fn = deep_reg_lstm_ln_model_v2
