...
from models.gating_hyper_nets import deep_projection_ivector_ln_model
...
if __name__ == '__main__':
    ...
    network_output, cond_layer_list = deep_projection_ivector_ln_model(input_var=input_data,
                                                                       cond_var=input_cond,
                                                                       mask_var=input_mask,
