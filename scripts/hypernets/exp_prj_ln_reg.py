...
def build_trainer(input_data,
    ...
    for cond_layer in cond_layer_list:
        ...
        sample_feat_cost = T.dot(sample_feat, T.transpose(sample_feat))
        sample_feat_cost *=(T.ones_like(sample_feat_cost)-T.eye(n=sample_feat_cost.shape[0]))
...
if __name__ == '__main__':
    ...
    network_output, cond_layer_list = deep_projection_cond_ln_model(input_var=input_data,
                                                                    mask_var=input_mask,
