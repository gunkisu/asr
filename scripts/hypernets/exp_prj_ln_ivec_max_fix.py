...
from models.gating_hyper_nets import deep_projection_max_ivector_ln_model_fix
...
def get_save_path(args):
    path = args.save_path
    path += '/wsj_prj_ln_ivector_max_fix'
...
if __name__ == '__main__':
    ...
    network_output, cond_layer_list = deep_projection_max_ivector_ln_model_fix(input_var=input_data,
                                                                               cond_var=input_cond,
                                                                               mask_var=input_mask,
